package fl.wearable.autosport.unit.proto
...
import fl.wearable.autosport.proto.SyftTensor
import fl.wearable.autosport.proto.toSyftTensor
...
internal class SyftModelTest {
    ...
    fun `Given a list of params when model is updated and tensor list size does not match then an exception is thrown`() {
        // Given
        mockkStatic("fl.wearable.autosport.proto.SyftTensorKt")
