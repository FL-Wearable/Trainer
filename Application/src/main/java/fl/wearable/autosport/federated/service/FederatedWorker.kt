package fl.wearable.autosport.federated.service
...
import fl.wearable.autosport.federated.ui.main.AUTH_TOKEN
import fl.wearable.autosport.federated.ui.main.BASE_URL
import fl.wearable.autosport.federated.ui.ContentState
import fl.wearable.autosport.federated.ui.ProcessData
import fl.wearable.autosport.federated.ui.work.WorkInfoActivity
...
class FederatedWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        val config = SyftConfiguration.builder(serviceContext, baseUrl)
                ...
                .setCacheTimeout(0L)
                .build()
        val LocalAllinoneDataSource = LocalAllinoneDataSource(serviceContext.resources)
    ...
    inner class WorkLogger : ActivityLogger {
