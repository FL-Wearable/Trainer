...
import fl.wearable.autosport.networking.datamodels.syft.SpeedCheckResponse
 ...
 *
 * @See fl.wearable.autosport.networking.clients.HttpClient
 */
internal interface HttpAPI : CommunicationAPI {
     ...
     *
     * @param cycleRequest @see fl.wearable.autosport.networking.datamodels.syft.CycleRequest
     */
